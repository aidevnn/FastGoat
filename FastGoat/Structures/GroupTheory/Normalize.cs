...
public class Normalize<U> : SubGroup<U> where U : struct, IElt<U>
{
...
{
    public static Normalize<U> NormalizeIn<U>(this SubSet<U> s, SubGroup<U> h) where U : struct, IElt<U>
    {
        return new Normalize<U>(h, s);
    }

    public static Normalize<U> Normalize<U>(this SubGroup<U> h, SubSet<U> s) where U : struct, IElt<U>
    {
        return new Normalize<U>(h, s);
    }
}