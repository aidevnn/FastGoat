...
public static class GroupOrder21
{
    ...
    {
        var z21 = new Zn(21);
        var g21 = Group.Generate(z21, z21[1]);
    ...
    public static void ZnDirectProduct()
    {
        ...
        var g21 = Group.Generate(z7Xz3, z7Xz3[1, 0], z7Xz3[0, 1]);
        DisplayGroup.HeadElements(g21);
    }
    ...
    {
        var c7 = Group.Generate("C7", new Zn(7), new Zn(7)[1]);
        var c3 = Group.Generate("C3", new Zn(3), new Zn(3)[1]);
