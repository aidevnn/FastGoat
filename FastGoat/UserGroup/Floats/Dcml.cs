...
public readonly struct Dcml : IElt<Dcml>, IRingElt<Dcml>, IFieldElt<Dcml>, IModuleElt<Rational, Dcml>,
    IVsElt<Rational, Dcml>, IFloatElt<Dcml>, IFixedPrecisionElt<Dcml>
{
