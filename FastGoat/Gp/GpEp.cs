...
public struct Gp3<T1,T2,T3> : IGroup<Ep3<T1,T2,T3>> where T1:IElt<T1> where T2:IElt<T2> where T3:IElt<T3>
{
        ...
        public Ep3<T1,T2,T3> Op(Ep3<T1,T2,T3> e1, Ep3<T1,T2,T3> e2) => new(G1.Op(e1.E1,e2.E1), G2.Op(e1.E2,e2.E2), G3.Op(e1.E3,e2.E3));
...
public struct Gp4<T1,T2,T3,T4> : IGroup<Ep4<T1,T2,T3,T4>> where T1:IElt<T1> where T2:IElt<T2> where T3:IElt<T3> where T4:IElt<T4>
{
        public string Name { get; }
        public IGroup<T1> G1 {get;}
        public IGroup<T2> G2 {get;}
        ...
        public Ep4<T1,T2,T3,T4> Invert(Ep4<T1,T2,T3,T4> e) => new(G1.Invert(e.E1), G2.Invert(e.E2), G3.Invert(e.E3), G4.Invert(e.E4));
        public Ep4<T1,T2,T3,T4> Op(Ep4<T1,T2,T3,T4> e1, Ep4<T1,T2,T3,T4> e2) => new(G1.Op(e1.E1,e2.E1), G2.Op(e1.E2,e2.E2), G3.Op(e1.E3,e2.E3), G4.Op(e1.E4,e2.E4));
...
public struct Ep4<T1,T2,T3,T4> : IElt<Ep4<T1,T2,T3,T4>> where T1:IElt<T1> where T2:IElt<T2> where T3:IElt<T3> where T4:IElt<T4>
{
...
public struct Gp5<T1,T2,T3,T4,T5> : IGroup<Ep5<T1,T2,T3,T4,T5>> where T1:IElt<T1> where T2:IElt<T2> where T3:IElt<T3> where T4:IElt<T4> where T5:IElt<T5>
{
        public string Name { get; }
        public IGroup<T1> G1 {get;}
        public IGroup<T2> G2 {get;}
        ...
        public Ep5<T1,T2,T3,T4,T5> Invert(Ep5<T1,T2,T3,T4,T5> e) => new(G1.Invert(e.E1), G2.Invert(e.E2), G3.Invert(e.E3), G4.Invert(e.E4), G5.Invert(e.E5));
        public Ep5<T1,T2,T3,T4,T5> Op(Ep5<T1,T2,T3,T4,T5> e1, Ep5<T1,T2,T3,T4,T5> e2) => new(G1.Op(e1.E1,e2.E1), G2.Op(e1.E2,e2.E2), G3.Op(e1.E3,e2.E3), G4.Op(e1.E4,e2.E4), G5.Op(e1.E5,e2.E5));
...
public struct Ep5<T1,T2,T3,T4,T5> : IElt<Ep5<T1,T2,T3,T4,T5>> where T1:IElt<T1> where T2:IElt<T2> where T3:IElt<T3> where T4:IElt<T4> where T5:IElt<T5>
{
...
public static partial class Product
{
    public static Gp5<T1,T2,T3,T4,T5> Group<T1, T2, T3, T4, T5>(IGroup<T1> g1, IGroup<T2> g2, IGroup<T3> g3, IGroup<T4> g4, IGroup<T5> g5)
...
public struct Gp6<T1,T2,T3,T4,T5,T6> : IGroup<Ep6<T1,T2,T3,T4,T5,T6>> where T1:IElt<T1> where T2:IElt<T2> where T3:IElt<T3> where T4:IElt<T4> where T5:IElt<T5> where T6:IElt<T6>
{
        public string Name { get; }
        public IGroup<T1> G1 {get;}
        public IGroup<T2> G2 {get;}
        ...
        public int Hash { get; }
        public Ep6<T1,T2,T3,T4,T5,T6> Neutral() => new(G1.Neutral(), G2.Neutral(), G3.Neutral(), G4.Neutral(), G5.Neutral(), G6.Neutral());
        public Ep6<T1,T2,T3,T4,T5,T6> Invert(Ep6<T1,T2,T3,T4,T5,T6> e) => new(G1.Invert(e.E1), G2.Invert(e.E2), G3.Invert(e.E3), G4.Invert(e.E4), G5.Invert(e.E5), G6.Invert(e.E6));
        public Ep6<T1,T2,T3,T4,T5,T6> Op(Ep6<T1,T2,T3,T4,T5,T6> e1, Ep6<T1,T2,T3,T4,T5,T6> e2) => new(G1.Op(e1.E1,e2.E1), G2.Op(e1.E2,e2.E2), G3.Op(e1.E3,e2.E3), G4.Op(e1.E4,e2.E4), G5.Op(e1.E5,e2.E5), G6.Op(e1.E6,e2.E6));
...
public struct Ep6<T1,T2,T3,T4,T5,T6> : IElt<Ep6<T1,T2,T3,T4,T5,T6>> where T1:IElt<T1> where T2:IElt<T2> where T3:IElt<T3> where T4:IElt<T4> where T5:IElt<T5> where T6:IElt<T6>
{
...
public static partial class Product
{
    public static Gp6<T1,T2,T3,T4,T5,T6> Group<T1, T2, T3, T4, T5, T6>(IGroup<T1> g1, IGroup<T2> g2, IGroup<T3> g3, IGroup<T4> g4, IGroup<T5> g5, IGroup<T6> g6)
        where T1:IElt<T1> where T2:IElt<T2> where T3:IElt<T3> where T4:IElt<T4> where T5:IElt<T5> where T6:IElt<T6>
    {
