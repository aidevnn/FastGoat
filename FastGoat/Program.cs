...

{
    ...
    foreach (var (r, s, O) in rsO.SkipLast(3))
    {
    ...
    // LLLminPoly(r: 2 s: 2, O: 20);
    //
    // PSLQminPoly(r: 3, s: 3, O: 40);
    // LLLminPoly(r: 3, s: 3, O: 40);
    //
    // PSLQminPoly(r: 2, s: 5, O: 50);
    // LLLminPoly(r: 2, s: 5, O: 50);
    //
    // PSLQminPoly(r: 3, s: 4, O: 70);
    // LLLminPoly(r: 3, s: 4, O: 70);
    //
    // PSLQminPoly(r: 2, s: 7, O: 90);
    // LLLminPoly(r: 2, s: 7, O: 90);
    //
    // PSLQminPoly(r: 3, s: 5, O: 90);
    // LLLminPoly(r: 3, s: 5, O: 90);
    //
    // PSLQminPoly(r: 4, s: 4, O: 90);
    // LLLminPoly(r: 4, s: 4, O: 90);
    //
    // PSLQminPoly(r: 4, s: 5, O: 120);
    // LLLminPoly(r: 4, s: 5, O: 120);
}